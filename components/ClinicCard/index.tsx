  ...
  return (
    <div className={styles.card}>
      <div className={styles.left}>
        <div className={styles.header}>
          ...
          <div className={styles.titleArea}>
            ...
            {Region?.name ? (
              <p className={styles.region}>{Region.name}</p>
            ) : null}
          </div>
        </div>
              ...
              <div key={cs.id} className={styles.serviceRow}>
                ...
                {cs.price ? (
                  <span className={styles.servicePrice}>
                    {Intl.NumberFormat("uz-UZ").format(Number(cs.price))} so'm
                  </span>
                ) : null}
              </div>
            ))}
                ...
                return (
                  ...
                  >
                    {d.image_url ? (
                      ...
                      <div className={styles.doctorAvatarStub} />
                    )}
      ...
      <div className={styles.right}>
        ...
        {hoursToday ? (
          <p className={styles.detailItem}>Har doim ochiq: {hoursToday}</p>
        ) : null}
